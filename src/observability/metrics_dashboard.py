...
class MetricsDashboard:
    ...
    def _render_dashboard(self):
        ...
        print(
            f"Last Updated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}".center(80))
        print("=" * 80)
        print()
        ...
        if self.query_learning_system:
            try:
                ...
                if metrics:
                    ...
                    print(
                        f"Avg Execution Time: {metrics.get('avg_execution_time_ms', 0):.1f} ms")
                    print(
                        f"P95 Execution Time: {metrics.get('p95_execution_time_ms', 0):.1f} ms")
    ...
    def get_summary_report(self) -> Dict[str, Any]:
        ...
        if self.query_learning_system:
            try:
                report['performance'] = self.query_learning_system.get_performance_metrics(
                    days=7)
            except Exception as e:
    ...
    def display_compact(self):
        ...
        try:
            ...
            print(
                f"RAG Status: {status} | Queries (24h): {query_count} | "
